        ...
        <div className='py-20 '>
            <div className=' my-2  p-2 max-w-sm  mx-auto border-2 border-black rounded-lg'>
                <div className="w-full px-2 py-4 grid gap-3 ">
                    ...
                    <Link to={"/signup/vender"} className='bg-blue-600 px-3 py-2 text-center border-2  w-full mx-auto block text-white  hover:bg-blue-700 transition-all'>Signin with Gmail Or Phone number</Link>
                </div>
