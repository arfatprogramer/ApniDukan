...
import { addProduct } from "../common/apiData";
import color from '../helper/color';



const AddProduct = ({ onClose,allProductData }) => {
    ...
    const handelOnSubmit = async (e) => {
        ...
        const serverResponse = await fetch(addProduct.url, {
        ...
        <div className='fixed max-sm:mx-4 bottom-0 top-0 left-0 right-0 flex justify-center items-center bg-gray-300 bg-opacity-25 overflow-hidden z-50'>
            <div className=' bg-gray-100 shadow-lg text-black  p-2 w-[600px] h-[650px]  mx-auto border-2 border-black rounded-lg overflow-auto' >
                <div className="flex justify-between p-2 pb-4">
                    <h1 className="font-bold text-2xl">Upload New Product</h1>
                ...
                <form onSubmit={handelOnSubmit}>
                    ...
                    <div className="w-full px-2 mb-2 ">
                        <label htmlFor="selling">No of Stock</label>
                        <div className="flex w-full my-1 ">
                            <input type="number"
                                name='stock'
                                placeholder='Selling Price'
                    ...
                    <div className="w-full px-2 py-3 ">
                        <button type="submit" disabled={disableButton} className='bg-blue-600 px-3 py-2  border-2 w-full mx-auto block text-white hover:scale-105 hover:bg-blue-700 transition-all  disabled:bg-gray-300'>Upload</button>
