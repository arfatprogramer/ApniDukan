...
import { signup, userUpdate } from '../common/apiData';
import { FaEye, FaEyeSlash, FaRegUser } from 'react-icons/fa';
import { IoCloseSharp } from 'react-icons/io5';
import { ContextProvider } from "../context/index";

const UpdateUserProfile = ({ userData, OnClose }) => {
    ...
    const handelSubmit = async (e) => {
        ...
        let serverResponse = await fetch(userUpdate.url, {
    ...
    return (
        <div className="w-full h-screen absolute bg-white top-0 left-0 bottom-0 z-50 ">
            <div className='py-20 '>
