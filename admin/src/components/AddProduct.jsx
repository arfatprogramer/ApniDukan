...
import { addProduct } from "../common/ApiUrls";
            ...
            <div className=' bg-gray-100 shadow-lg text-black  p-2 w-[600px] h-[650px]  mx-auto border-2 border-black rounded-lg overflow-auto' >
                ...
                <form onSubmit={handelOnSubmit}>
                    ...
                    <div className="w-full px-2 py-3 ">
                        <button type="submit" className='bg-blue-600 px-3 py-2  border-2 w-full mx-auto block text-white hover:scale-105 hover:bg-blue-700 transition-all'>Upload</button>
