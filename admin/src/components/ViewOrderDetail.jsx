...
const ViewOrderDetail = ({ orderId, onClose,viewOrderData }) => {
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-gray-300 bg-opacity-50 overflow-y-auto">
      <div className="bg-white p-6 w-full max-w-4xl mx-auto border-2 border-black rounded-lg max-h-screen overflow-y-auto">
        ...
        <form onSubmit={handelOnSubmit}>
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-between mt-6">
              ...
              <p className={`text-${orderData.deliveryStatus === 'cancel' ? 'red' : 'green'}-500 font-bold`}>{orderData.deliveryStatus}</p>
            </div>
